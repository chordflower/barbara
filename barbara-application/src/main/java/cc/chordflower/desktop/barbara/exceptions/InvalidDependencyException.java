...
/**
 * Exception thrown when there is an invalid dependency in a plugin descriptor.
 *
 * @author carddamom
 */
public class InvalidDependencyException extends Exception {

  private static final Logger LOGGER = LoggerFactory.getLogger( InvalidDependencyException.class );
